...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        assertEquals("주문한 가격은 가격 * 수량", 10000 * 2, getOrder.getTotalPrice());
        assertEquals("상품 주문시 상태는 ORDER", OrderStatus.ORDER, getOrder.getStatus());
    ...
    private Member createMember() {
        ...
        member.setName("회원1");
        member.setAddress(new Address("서울", "마포구", "1-1"));
        em.persist(member);
        return member;
    }
    ...
    public void 주문취소() {
        ...
        assertEquals("주문이 취소된 상품은 재고량 복구", 10, item.getStockQuantity());
    }
}
